...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  return (
    <footer className="bg-[#1a1a1a] text-[#faf8f5] pt-24 pb-12 border-t border-[#d4af37]/30 overflow-hidden relative">
      ...
      <div className="absolute top-0 right-0 text-[15vw] font-serif font-bold text-white/[0.02] pointer-events-none select-none translate-x-1/4 -translate-y-1/4 z-[1]">
        PRESTIGE
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 pb-20 border-b border-[#d4af37]/10 relative z-10">
      ...
      {/* REFINEMENT FOOTER */}
      <div className="max-w-7xl mx-auto px-6 pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-12 relative z-10">
      ...
      {/* DISCRETIONARY & LEGAL */}
      <div className="max-w-7xl mx-auto px-6 mt-16 pt-12 border-t border-white/5 flex flex-col items-center space-y-8 relative z-10">
